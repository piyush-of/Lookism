...
export default function Home() {
  ...
  // If the user has already seen the intro in this session, we can skip it. 
  // For now, it plays every time they load the page.
        ...
        <main className={styles.main}>
          <header className={styles.header}>
            ...
            <p className={styles.subtitle}>
              AI-Powered, Privacy-First Beauty & Style Analysis.
              <br />
              Discover your aesthetic, body shape, and color palette securely.
            </p>
          </header>
          ...
          <section className={styles.content}>
            ...
            {isAnalyzing && (
              <div style={{ textAlign: "center", padding: "4rem", color: "#a1a1aa" }}>
                ...
                <p style={{ marginTop: "1rem" }}>Securely analyzing your aesthetic...</p>
              </div>
            )}
